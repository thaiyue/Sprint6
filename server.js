...
const characters = [
  ...
  new Character ({name: "Beta-Ray-Bill", apiId: "1009180", image:"https://imagesvc.timeincapp.com/v3/fan/image?url=https://fansided.com/files/2018/02/black-panther-1-2018-header.jpg&", description: `Bill becomes the first being outside the Marvel Universe's Norse pantheon to be deemed worthy to wield Thor's hammer, Mjolnir.`, gender: "Male", universe: "Asgard", alias: "Beta Ray Bill"}),
  new Character ({name: "Black Panther", apiId: "1009187", image:"https://pbs.twimg.com/media/Dg1CiKcUwAAQTik.jpg", description: `As the king of the African nation of Wakanda, T’Challa protects his people as the latest in a legacy line of Black Panther warriors.`, gender: "Male", universe: "Avengers", alias: `King T'challa`}),
  ...
  new Character ({name: "X-23", apiId: "1009722", image:"https://image-store.slidesharecdn.com/0901d54d-ed65-4b8a-b0e0-c5872fc6c188-original.jpeg", description: "X-23 was apparently the clone and later adopted daughter of Wolverine, created to be the perfect killing machine. For years, she proved herself a capable assassin working for an organization called the Facility. She becomes a hero in her own right after wearing the mantle of Wolverine.", gender: "Female", universe: "X-Men",alias: "Laura Kinney"}),
  ...
  new Character ({name: "Zzzax", apiId: "1009742", image:"https://image-store.slidesharecdn.com/0901d54d-ed65-4b8a-b0e0-c5872fc6c188-original.jpeg", description: "The collected entity of a host of individuals who died a violent death at a nuclear power plant.", gender: "Male", universe: "Avengers", alias:"not applicable"}),
...
//     const letter = new Letter({ letterChar: letter, characters: ids })
//     letter.save().then(() => {
